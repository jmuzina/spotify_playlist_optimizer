...
var SpotifyStrategy =
  require("./node_modules/passport-spotify/lib/passport-spotify/index").Strategy;
  ...
  new SpotifyStrategy(
    {
      ...
      callbackURL:
        "https://playlist-optimizer.jmuzina.io/spotify_auth_callback",
      ...
      User.findOrCreate(
        {
          ...
          profile_picture: FUNCTIONS.get_image(
            profile.photos,
            "profile_picture"
          ),
          keys: {
...
function ensureAuthenticated(req, res, next) {
  ...
  User.deleteUser(req, function () {
    console.log(
      "[ERROR] Sent user back to homepage due to authentication failure"
    );
    res.redirect("/");
  });
}
